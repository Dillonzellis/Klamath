...
(function ($) {
  ...
  $(window).on("load", function () {
    ...
    $("#packageSlider").owlCarousel({
      ...
      navigationText: [
        "<img class='svg' src='images/svg/arrow-left-w.svg' onerror='this.src='arrow-left-w.png' alt='Prev' />",
        "<img class='svg' src='images/svg/arrow-right-w.svg' onerror='this.src='arrow-right-w.png'' alt='Next' />",
      ],
      pagination: false,
    });
    ...
    if (svgAlign.length > 0) {
      ...
      setTimeout(function () {
        $(
          "figure.grid-item figcaption > a.zoom .svg, .grid-item a.zoom .svg"
        ).each(function () {
          var ths = $(this);
          vCenterAlign(ths);
        });
  ...
  if (cForm.length > 0) {
        ...
        $.post(
          ...
          function (response) {
            if (response.type == "error") {
              ...
              //reset values in all input fields
              $(
                "#cForm  input[required=true], #cForm textarea[required=true]"
              ).val("");
    ...
    //reset previously set border colors and hide all message on .keyup()
    $("#cForm  input[required=true], #cForm textarea[required=true]").keyup(
      function () {
        $(this).css("border-color", "");
